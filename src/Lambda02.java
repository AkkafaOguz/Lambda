...
public class Lambda02 {
    ...
    public static void main(String[] args) {
        ...
        List <Double> halfOfGreaterThan5= l.
                                            stream().
